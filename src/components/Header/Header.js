...
import icon_vn from '../../image/Vietnam_26405.png';
import icon_us from '../../image/Usa_26407.png';
...
const Header = () => {
    ...
    return(
        <div>
            <nav className="navbar navbar-expand-sn bg-light shadow-lg justify-content-between">
                ...
                <div className="d-flex">
                    ...
                    <div className="language ml-3">
                        <form className="d-flex" onSubmit={handleSubmitButton}>
